...
typedef enum {  RAOP_INT_PREPARE, RAOP_INT_SETUP, RAOP_INT_STREAM, RAOP_INT_PLAY, RAOP_INT_FLUSH, RAOP_INT_METADATA, RAOP_INT_ARTWORK, RAOP_INT_PROGRESS, RAOP_INT_PAUSE, RAOP_INT_STOP, RAOP_INT_STALLED,
